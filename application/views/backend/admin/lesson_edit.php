...
$courses = $this->crud_model->get_institute_by_course($lesson_details['course_id'])->row_array();
$institute = $this->crud_model->get_institute($courses['institute_id'])->row_array();
$ins_name = str_replace(' ','_',$institute['first_name']).'_'.str_replace(' ','_',$institute['last_name']);
$course = str_replace(' ','_',$courses['title']);
// echo '<pre>',print_r($lesson_details),'</pre>';
// die;
...
<form action="<?php echo site_url('admin/lessons/'.$param3.'/edit'.'/'.$param2); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="" id="video" <?php if($lesson_details['lesson_type'] != 'video'):?> style="display: none;" <?php endif; ?>>
        ...
        <div class="form-group">
            ...
            <select class="form-control select2" data-toggle="select2" name="lesson_provider" id="lesson_provider" onchange="check_video_provider(this.value)">
                ...
                <option value="s3" <?php if(strtolower($lesson_details['video_type']) == 'amazon') echo 'selected'; ?>><?php echo get_phrase('video_upload'); ?></option>
    ...
    <div class="" id = "amazon-s3" style="display: none;">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" data-toggle='timepicker' data-minute-step="5" name="amazon_s3_duration" id = "amazon_s3_duration" data-show-meridian="false"  value="<?php echo $lesson_details['duration']; ?>">
        </div>
    </div>
