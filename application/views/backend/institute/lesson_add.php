...
<form action="<?php echo site_url('institute/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="text-center">
            <button class = "btn btn-success" type="submit" id="add_lesson" name="button"><?php echo get_phrase('add_lesson'); ?></button>
        </div>
    </form>
